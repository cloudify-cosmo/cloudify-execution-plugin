...
def create_initial_globals(path_):
    ...
    del copied_globals['create_initial_globals']
    copied_globals['__doc__'] = ('this module includes a lone function whose '
                                 'purpose is to emulate the return value of '
                                 '`globals()` when called in a freshly loaded '
                                 'empty module')
    copied_globals['__file__'] = path_
